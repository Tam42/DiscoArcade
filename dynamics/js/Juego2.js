...
finalizar.addEventListener("click",()=>{
  document.cookie = "score=0;expires="+c.toGMTString();
  ...
  .then((text)=>{
    console.log(text);
    fetch("../dynamics/php/score.php?score="+score+"&nombre="+text)
    .then((response)=>{
      console.log("Exitoso");
    })
  })
